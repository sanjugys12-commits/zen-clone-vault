  ...
  return (
    <div className={cn("relative", className)}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-3 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 min-w-[120px]"
      >
